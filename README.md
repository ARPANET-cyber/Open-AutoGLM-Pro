...
1. 可以使用http://arpanet.icu:3000/ 注册来调用gemini3,gemini2.5,claude等模型
2. 无需部署,注册后即可通过创建令牌来调用模型.


- 关于模型部署的详细内容，你也以查看 https://www.yuque.com/wenhemian/mar0qk/rfamx4g2gu7ywg1s

- 创建好令牌后,将可以通过 `http://arpanet.icu:3000/v1` 访问模型服务。 
...
```bash
# 交互模式
python main.py --base-url “http://arpanet.icu:3000/v1”  --api-key "sk-xxxxxxxxx"  --model "gemini-3-pro-preview"

# 指定模型端点
python main.py --base-url “http://arpanet.icu:3000/v1” "打开美团搜索附近的火锅店"

# 使用英文 system prompt
python main.py --lang en --base-url “http://arpanet.icu:3000/v1” "Open Chrome browser"
...
model_config = ModelConfig(
    base_url=“http://arpanet.icu:3000/v1”,
...
# 指定设备执行任务
python main.py --device-id 192.168.1.100:5555 --base-url “http://arpanet.icu:3000/v1” --model "gemini-3-pro-preview" "打开抖音刷视频"
```
